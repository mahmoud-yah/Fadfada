...
List<ThemeData> getThemes() {
  return [
    ThemeData(backgroundColor: Colors.black,primaryColor: Colors.white ,accentColor: Color(0xFF833AC7),brightness: Brightness.dark,iconTheme: IconThemeData(color: Colors.white)),
